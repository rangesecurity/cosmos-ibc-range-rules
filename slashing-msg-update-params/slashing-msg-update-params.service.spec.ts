...
describe('ProcessorsService::SlashingMsgUpdateParamsService', () => {
  ...
  it('should generate an alert for transactions for slashing-msg-update-params', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving slashing-msg-update-params', async () => {
    // todo
  });
});
