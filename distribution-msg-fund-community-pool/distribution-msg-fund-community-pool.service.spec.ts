...
import { TestRangeSDK } from '@range-security/range-sdk';
...
describe('ProcessorsService::DistributionMsgFundCommunityPoolService', () => {
  ...
  it('should generate an alert for transactions for distribution-msg-fund-community-pool', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving distribution-msg-fund-community-pool', async () => {
    // todo
  });
});
