...
describe('ProcessorsService::AuthMsgUpdateParamsService', () => {
  ...
  it('should generate an alert for transactions for auth-msg-update-params', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving auth-msg-update-params', async () => {
    // todo
  });
});
