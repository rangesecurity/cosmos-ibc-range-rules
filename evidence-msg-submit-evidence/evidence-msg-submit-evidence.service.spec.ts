...
describe('ProcessorsService::EvidenceMsgSubmitEvidenceService', () => {
  ...
  it('should generate an alert for transactions for evidence-msg-submit-evidence', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving evidence-msg-submit-evidence', async () => {
    // todo
  });
});
