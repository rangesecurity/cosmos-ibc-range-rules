...
describe('ProcessorsService::ConsumerRewardsTimeService', () => {
  ...
  it('should generate an alert for transactions for consumer-rewards-time', async () => {
        ...
        begin_block: [
          {
            ...
            attributes: [
              ...
              { key: 'current_distribution_height', value: '4267500' },
              { key: 'next_distribution_height', value: '4269000' },
              { key: 'distribution_fraction', value: '0.75' },
              { key: 'total', value: '' },
              {
                key: 'provider_amount',
                value:
                  '69377ibc/C4CFF46FD6DE35CA4CF4CE031E643C8FDC9BA4B99AE598E9B0ED98FE3A2319F9,1384132untrn',
              },
            ],
          },
        ],
  ...
  it('should not generate any alerts for transactions not involving consumer-rewards-time', async () => {
    const block: IRangeBlock = {
      hash: '',
      height: '0',
      transactions: [],
