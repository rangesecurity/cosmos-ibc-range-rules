...
describe('ProcessorsService::DowntimeSlashService', () => {
  ...
  it('should generate an alert for transactions for downtime-slash', async () => {
        ...
        begin_block: [
          {
            ...
            attributes: [
              ...
              { key: 'infraction_type', value: 'INFRACTION_TYPE_DOWNTIME' },
            ],
          },
        ],
        end_block: [],
    ...
    const expectedAlerts = [
      {
        ...
        details: {
          message:
            'A consumer initiated downtime slashing request has been initiated for validator neutronvalcons12ys9vkd8zl0lh9hq2nut6yggwv8p0t48uugx9x.',
        },
        txHash: '',
        severity: 'medium',
        caption: 'Consumer chain Downtime slash request',
      },
    ];
  ...
  it('should not generate any alerts for transactions not involving downtime-slash', async () => {
    const block: IRangeBlock = {
      hash: '',
      height: '0',
      transactions: [],
