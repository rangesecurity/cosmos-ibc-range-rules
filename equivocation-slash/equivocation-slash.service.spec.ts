...
describe('ProcessorsService::EquivocationSlashService', () => {
  ...
  it('should generate an alert for transactions for equivocation-slash', async () => {
        ...
        begin_block: [
          {
            ...
            attributes: [
              ...
              { key: 'infraction_type', value: 'INFRACTION_TYPE_DOUBLE_SIGN' },
            ],
          },
        ],
        end_block: [],
    ...
    const expectedAlerts = [
      {
        ...
        details: {
          message:
            'A consumer initiated equivocation slashing request has been initiated for validator neutronvalcons12ys9vkd8zl0lh9hq2nut6yggwv8p0t48uugx9x.',
        },
        txHash: '',
        severity: 'high',
  ...
  it('should not generate any alerts for transactions not involving equivocation-slash', async () => {
    const block: IRangeBlock = {
      hash: '',
      height: '0',
      transactions: [],
