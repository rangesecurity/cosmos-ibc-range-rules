...
describe('ProcessorsService::BankMsgUpdateParamsService', () => {
  ...
  it('should generate an alert for transactions for bank-msg-update-params', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving bank-msg-update-params', async () => {
    // todo
  });
});
