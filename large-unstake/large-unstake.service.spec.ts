...
describe('ProcessorsService::LargeUnstakeService', () => {
  ...
  it('should generate an alert for transactions for large unstake', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving large unstake', async () => {
    // todo
  });
});
