...
describe('ProcessorsService::AuthzAbuseService', () => {
  ...
  it('should generate an alert for transactions for authz-abuse', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving authz-abuse', async () => {
    // todo
  });
});
