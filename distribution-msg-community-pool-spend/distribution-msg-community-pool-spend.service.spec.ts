...
describe('ProcessorsService::DistributionMsgCommunityPoolSpendService', () => {
  ...
  it('should generate an alert for transactions for distribution-msg-community-pool-spend', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving distribution-msg-community-pool-spend', async () => {
    // todo
  });
});
