...
describe('ProcessorsService::CcvTimeoutService', () => {
  ...
  it('should generate an alert for transactions for ccv-timeout', async () => {
    // todo
  });

  it('should not generate any alerts for transactions not involving ccv-timeout', async () => {
    // todo
  });
});
